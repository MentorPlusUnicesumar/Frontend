  ...
  return (
    <Flex w={"100%"} h={"100%"} display={"flex"} flexDir={"row"}>
      <Flex
        ...
        bg={"#1D428A"}
      >
        <Text color={"white"} fontSize={"lg"} mt={"50px"}>
          Bem-vindo ao
        </Text>
        <Img src={logo} w={"320px"} h={"150px"} mt={"100px"} />
        <Text color={"white"} fontSize={"sm"} mt={"50px"} textAlign={"center"}>
      ...
      >
        ...
        <Text
          ...
          textAlign={"center"}
        >
          Insira o endereço de e-mail vinculado à sua conta do Mentor + para te
          enviarmos um e-mail.{" "}
        </Text>
