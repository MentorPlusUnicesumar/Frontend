...
export function CardMentoria({ nomeMentoria, mentorName, date }: props) {
    return (
        <Flex
            ...
            <Box px={'5px'} w={'full'} h={'90px'} borderTopRadius="10px" bgGradient="linear(to-r, #004DB8, #003C8F)">
            ...
            <Box borderBottomRadius={'10px'} p={'5px'} bg={'#F2F2F2'} w={'full'} h={'full'}>
                <Box>
                    <Text fontSize={'md'} fontWeight={'regular'} color={'#1D428A'}>Mentor:</Text>
                    <Text fontSize={'md'} fontWeight={'bold'} color={'#1D428A'}>{mentorName}</Text>
                </Box>
                <Box mt={'5px'}>
                    <Text fontSize={'md'} fontWeight={'regular'} color={'#1D428A'}>Próximo encontro:</Text>
